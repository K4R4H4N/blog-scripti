...
<div class="mr-5"><?php echo $istatistikler['yazi_sayisi']; ?> Yazı</div>
</div>
<a class="card-footer text-white clearfix small z-1" href="<?php echo base_url("admin/yazilar"); ?>">
...
<div class="mr-5"><?php echo $istatistikler['yazi_goruntulenme']; ?> Yazı Görüntülenme Sayısı</div>
</div>
...
<!-- son yazilar-->
<div class="mb-0 mt-4">
<i class="fa fa-newspaper-o"></i> Son paylaşılan yazılar</div>
<hr class="mt-2">
...
<div class="card mb-2">
<div class="card-body">
<h6 class="card-title mb-1"><a target="_blank" href="<?php echo base_url("yazi/$row->yazi_url"); ?>"><?php echo $row->yazi_baslik; ?></a></h6>
<p class="card-text small"><?php echo substr(strip_tags($row->yazi_icerik), 0 , 250); ?>...</p>
</div>
</div>
<!-- son yazilar -->
<?php } ?>
